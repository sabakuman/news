    ...
    <div className="min-h-screen flex items-center justify-center bg-primary relative overflow-hidden arabic-font" dir="rtl">
      ...
      <div className="w-full max-w-md p-10 bg-surface rounded-[40px] shadow-2xl z-10 relative border border-outline-variant/10">
        <div className="text-center mb-10">
          ...
          <p className="text-on-surface-variant font-medium">بوابة الموظفين - الإدارة العامة للإعلام</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-2">
            <label className="block text-xs font-bold text-on-surface-variant uppercase tracking-wider mr-1">البريد الإلكتروني</label>
            <div className="relative">
              <span className="material-symbols-rounded absolute right-4 top-1/2 -translate-y-1/2 text-on-surface-variant/40">mail</span>
              <input
                type="email"
                value={email}
          ...
          <div className="relative my-10">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-surface px-4 text-on-surface-variant font-bold">أو عبر</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full h-14 bg-surface-container-high border border-outline-variant hover:bg-surface-container-highest text-on-surface font-bold rounded-2xl transition-all flex items-center justify-center gap-3 disabled:opacity-70"
          >
        ...
        <div className="mt-10 pt-8 border-t border-outline-variant text-center">
          <p className="text-xs text-on-surface-variant font-medium">© 2026 الإدارة العامة للإعلام والاتصال الحكومي</p>
        </div>
      </div>
    </div>
  );
